...
import { Users, Calendar, BarChart, Settings, Phone, Home, MessageSquare, FileText, HelpCircle } from "lucide-react"
...
export function Sidebar({ open }: SidebarProps) {
  ...
  return (
    ...
    >
      <div className={cn("flex h-14 items-center border-b px-4", open ? "justify-between" : "justify-center")}>
